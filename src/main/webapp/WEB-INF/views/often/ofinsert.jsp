...
<body>
    ...
    <form action="/often/ofinsert" method="post">
        <ul class="register-list">
            <li class="register-item">
                <label class="register-label">제목</label>
                <input class="register-input" type="text" name="oSubject">
            </li>
            <li class="register-item">
                <label class="register-label">내용</label>
                <textarea class="register-textarea" rows="4" cols="50" name="oContent"></textarea>
            </li>
        </ul>
