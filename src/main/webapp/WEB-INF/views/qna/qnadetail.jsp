	...
	<body>
		<h1>후기 상세</h1>
			<ul>
				<li>
					<label>작성자</label>
					<input type="text" name="userId" value="${qna.userId }">
				</li>
				<li>
					<label>제목</label>
					<input type="text" name="rSubject" value="${qna.qSubject }" readonly>
				</li>
				<li>
					<label>내용</label>
					<p>${qna.qContent }</p>
				...
				<li>
					<label>작성날짜</label>
					<input type="datetime" name="qCreate" value="${qna.qCreate }">
				</li>
			</ul>
			<c:url var="qnaDelUrl" value="/qna/delete">
				<c:param name="qNo" value="${qna.qNo }"></c:param>
				<c:param name="writeuserId" value="${qna.userId }"></c:param>
			</c:url>
			...
			<hr>
<!-- 			댓글 등록 -->
				<form action="/qnareply/qnaadd" method="post">
					<input type="hidden" name="qnaReplyNo" value="${qna.qnaReplyNo }">
